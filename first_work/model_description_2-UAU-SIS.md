...
<!-- ![模型的状态转换](/imgs/1-s2.0-S0096300318302236-gr2_lrg.jpg =200) -->
<!-- <img src="/imgs/1-s2.0-S0096300318302236-gr2_lrg.jpg" width="350" align=center /> -->
...
<img src="/imgs/1-s2.0-S0378437117308130-gr1_lrg-fixed.jpg" width="500" align=center />
...
图3-1的双层网络物理层是2000个节点的BA网络，信息层是2000个节点的WS网络，可以看到在曲线稳定之前一段时间经历了逐渐衰减的震荡。这段震荡时期即便是作了100次蒙特卡洛模拟也无法消除。

图3-2是两层相关的BA网络上的模拟结果，前期和图3-1类似，但是即便是后期也无法完全消除震荡，这个形状在模型调试早期出现过，但在排除了bug之后应该表现得像图3-1的曲线形状，这种结果目前还无法解释。
